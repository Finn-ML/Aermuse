...
export function DesignTab({ landingPageData, onUpdate, onImageUpload, onAvatarUpload, onAvatarRemove, onBackgroundRemove, onVideoUpload, onVideoRemove, canAccessVideo = false }: DesignTabProps) {
  return (
