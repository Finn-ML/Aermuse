      ...
      >
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="min-w-0">
            <h3 className="font-bold text-base sm:text-lg text-[#B8860B]">All Key Protections Present</h3>
            <p className="text-[rgba(184,134,11,0.8)] mt-1 text-xs sm:text-sm">
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 sm:mb-6">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          >
            <FileSearch className="h-4 w-4 sm:h-5 sm:w-5 text-[#F7E6CA]" />
          </div>
          <div>
            <h3 className="text-base sm:text-lg font-bold text-[#660033]">Missing Protections</h3>
            <p className="text-xs sm:text-sm text-[rgba(102,0,51,0.5)]">Consider requesting these clauses</p>
          </div>
        </div>
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {importantCount > 0 && (
            <span
              className="px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.05em]"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                    <span className="font-semibold text-[#660033] text-sm sm:text-[15px]">{clause.clause}</span>
                    <span
